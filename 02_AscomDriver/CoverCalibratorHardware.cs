...
namespace ASCOM.FlipFlatPanelV2.CoverCalibrator
{
    ...
    internal static class CoverCalibratorHardware
    {
        ...
        static CoverCalibratorHardware()
        {
            try
            {
                tl = new TraceLogger("", "FlipFlatPanelV2.Hardware");
            ...
            if (newState)
            {
                if (!uniqueIds.Contains(uniqueId))
                {
                    if (uniqueIds.Count == 0)
                    {
                        ...
                        catch (Exception ex) { CloseSerialPort(); connectedState = false; throw; }
                    }
        ...
        internal static void OpenCover()
        {
            ...
            try
            {
                string r = SendCommand("COMMAND:OPEN");
        ...
        internal static void CloseCover()
        {
            ...
            try
            {
                string r = SendCommand("COMMAND:CLOSE");
